...
// end include: preamble.js
  ...
  var doAsyncFunc = (impl) => Asyncify.handleSleep((wakeUp) => {
          // console.log('there');
          impl().then((res) => wakeUp(res));
      });
  var __Impl_GetCharI = () => doAsyncFunc(() => Module['console'].getCharWithoutEnter());
  __Impl_GetCharI.isAsync = true;

  var __Impl_SetRawMode = (use) => {
  ...
  function real_fd_read(fd, iov, iovcnt, pnum) {
  try {
  ...
  var _fd_read = (fd, iov, iovcnt, pnum) => Asyncify.handleSleep((wakeUp) => {
...
var wasmImports = {
  /** @export */
  _Impl_GetCharI: __Impl_GetCharI,
  /** @export */
  _Impl_SetRawMode: __Impl_SetRawMode,
  /** @export */
